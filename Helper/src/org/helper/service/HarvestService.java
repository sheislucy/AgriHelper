...
public class HarvestService extends BaseService {
	...
	public JSONObject harvest(String fieldId) throws ParseException, IOException, org.json.simple.parser.ParseException {
		String time = String.valueOf(System.currentTimeMillis() / 1000);
		StringBuilder url = new StringBuilder("http://happyfarm.manyou-apps.com/api.php?mod=farmlandstatus&act=harvest&farmKey=");
