 ...
 * 
 */
public class WeedFriendService extends BaseService {
	...
	public JSONObject weedFriend(String friendId, String fieldId) throws ClientProtocolException, IOException, ParseException, org.json.simple.parser.ParseException {
		String time = String.valueOf(System.currentTimeMillis() / 1000);
		StringBuilder url = new StringBuilder("http://happyfarm.manyou-apps.com/api.php?mod=farmlandstatus&act=clearWeed&farmKey=");
